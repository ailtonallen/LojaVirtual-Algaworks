...
public class FotoService implements Serializable {
	...
	void init(){
		Path raizAplicacao = getDefault().getPath(System.getProperty("user.home"), ".lojavirtual");

		diretorioRaiz = raizAplicacao.resolve("fotos-produto");
		diretorioRaizTemp = getDefault().getPath(System.getProperty("java.io.tmpdir"), "lojavirtual-fotos-temp");
